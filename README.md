...
Read the complete [research report](https://github.com/saucemmmm/Machine-Learning-and-the-Robustness-of-Causal-Estimates/blob/main/Econ_MA.pdf) for the motivation, methodology, results, and references.
